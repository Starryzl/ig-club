package com.tencent.circle.server.config.websocket;
...
@Slf4j
@ServerEndpoint(value = "/ig/socket", configurator = WebSocketServerConfig.class)
@Component
public class IgSocket {
     ...
     * 存放所有在线的客户端
     */
    private static final Map<String, IgSocket> clients = new ConcurrentHashMap<>();
    ...
    public void sendMessage(String message) {
        for (Map.Entry<String, IgSocket> sessionEntry : clients.entrySet()) {
            String erp = sessionEntry.getKey();
            IgSocket socket = sessionEntry.getValue();
    ...
    public IgSocket getChickenSocket(String userName) {
