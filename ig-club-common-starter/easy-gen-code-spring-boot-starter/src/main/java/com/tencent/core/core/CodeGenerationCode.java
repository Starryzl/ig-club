...
import com.tencent.core.core.impl.JdbcPutContextHandler;
import com.tencent.core.core.sdk.FilePutContextHandler;
import com.tencent.core.core.sdk.PostCurFiledContextAware;
import com.tencent.core.entity.Context;
import com.tencent.core.entity.MapperInfo;
import com.tencent.core.utils.*;
...
public class CodeGenerationCode {
    ...
    public static void doGenCode(PostCurFiledContextAware aware) {
        ...
        try {
            // 01 获取入口配置文件
            GenConfig genConfig = com.tencent.core.utils.YamlUtils.loadYaml("genCode/gen.yml", GenConfig.class);
            ...
            for (String key : context.getKeys()) {
                ...
                if (value instanceof String && com.tencent.core.utils.FunctionUtils.isFunction(value)) {
                    value = com.tencent.core.utils.FunctionUtils.doFunction(value);
    ...
    private static void genCode(List<MapperInfo> infos, String templateBasePath) {
        ...
        infos.forEach(info -> {
            com.tencent.core.utils.CodeGeneratorUtils codeGenerator = new com.tencent.core.utils.CodeGeneratorUtils(templateBasePath);
    ...
    private static List<MapperInfo> getMapperInfos(GenConfig genConfig, VelocityContext context, PostCurFiledContextAware aware) {
        ...
        MapperConfig mapperConfig = com.tencent.core.utils.YamlUtils.loadYaml(genConfig.getMapperInfos(), MapperConfig.class);
